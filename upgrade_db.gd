...
const UPGRADES = {
	...
	"icespear5": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Ice Spear",
		"details": "An additional ice spear is thrown, damage increased by 2",
		"level": "Level: 5",
	...
	"javelin5": {
		"icon": WEAPON_PATH + "javelin_3_new_attack.png",
		"displayname": "Javelin",
		"details": "The javelin now does + 2 damage per attack",
		"level": "Level: 5",
	...
	"tornado1": {
		...
		"displayname": "Tornado",
		"details": "A winding tornado is summoned in a random direction infront of the you",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	...
	"tome1": {
		...
		"displayname": "Tome",
		"details": "Increases size of spells by 10%",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "upgrade"
	},
	...
	"scroll1": {
		...
		"displayname": "Scroll",
		"details": "Spells will shoot 5% faster",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "upgrade"
	},
	"scroll2": {
		"icon": ICON_PATH + "scroll_old.png",
		"displayname": "Scroll",
		"details": "Decreases of the cooldown of spells by an additional 5%",
		"level": "Level: 2",
	...
	"magnet1": {
		...
		"details": "Your experience gem pickup range is increased",
		"level": "Level 1",
		"prerequisite": [],
		"type": "upgrade"
	},
	...
	"food": {
		"icon": ICON_PATH + "sake.jpg",
		"displayname": "Hot Sake",
